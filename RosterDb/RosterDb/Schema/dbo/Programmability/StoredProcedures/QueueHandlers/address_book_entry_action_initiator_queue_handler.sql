...
/*
	The procedure implements [<schema>].[ADDRESS_BOOK_ENTRY_ACTION_INITIATOR] queue entry handler
*/
CREATE PROCEDURE [dbo].[address_book_entry_action_initiator_queue_handler]
	...
	BEGIN TRY
		...
		BEGIN
			...
			(
				...
				FROM
					[dbo].[ADDRESS_BOOK_ENTRY_ACTION_INITIATOR]
			), TIMEOUT 600;
			...
			IF @message_type = N'//CompanyName/Roster/AddressBookEntryAction/Saved/Reply'
			BEGIN
				
				EXEC [dbo].[companyname_roster_addressbookentryaction_saved_reply_message_handler] 
