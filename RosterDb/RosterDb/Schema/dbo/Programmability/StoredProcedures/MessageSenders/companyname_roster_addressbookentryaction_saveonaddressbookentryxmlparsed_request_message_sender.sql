...
/*
	The procedure implements message sender for message type = [//CompanyName/Roster/AddressBookEntryAction/SaveOnAddressBookEntryXmlParsed/Request]
*/
CREATE PROCEDURE [dbo].[companyname_roster_addressbookentryaction_saveonaddressbookentryxmlparsed_request_message_sender]
	...
	BEGIN TRY
		...
		IF @tran_count = 0
			...
			SEND 
				...
				MESSAGE TYPE [//CompanyName/Roster/AddressBookEntryAction/SaveOnAddressBookEntryXmlParsed/Request]
				(@message_body_xml);   
