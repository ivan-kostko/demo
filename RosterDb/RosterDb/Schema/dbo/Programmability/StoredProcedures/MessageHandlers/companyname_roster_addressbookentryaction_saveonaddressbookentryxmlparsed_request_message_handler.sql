...
/*
	The procedure implements message handler for message type = [//CompanyName/Roster/AddressBookEntryAction/SaveOnAddressBookEntryXmlParsed/Request]
*/
CREATE PROCEDURE [dbo].[companyname_roster_addressbookentryaction_saveonaddressbookentryxmlparsed_request_message_handler]
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			EXEC [dbo].[register_addressbookentryxml_parsed]
