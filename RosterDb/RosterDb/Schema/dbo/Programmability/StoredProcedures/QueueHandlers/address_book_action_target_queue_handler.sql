...
/*
	The procedure implements [<schema>].[ADDRESS_BOOK_ACTION_TARGET] queue entry handler
*/
CREATE PROCEDURE [dbo].[address_book_action_target_queue_handler]
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			IF @message_type = N'//CompanyName/Roster/AddressBookAction/Register/Request'
			BEGIN
				...
				;SEND 
					...
					MESSAGE TYPE [//CompanyName/Roster/AddressBookAction/Register/Reply]
