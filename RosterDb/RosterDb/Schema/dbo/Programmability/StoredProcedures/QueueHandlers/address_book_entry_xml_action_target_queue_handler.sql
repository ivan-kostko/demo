...
/*
	The procedure implements [<schema>].[ADDRESS_BOOK_ENTRY_XML_ACTION_TARGET] queue entry handler
*/
CREATE PROCEDURE [dbo].[address_book_entry_xml_action_target_queue_handler]
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			IF @message_type = N'//CompanyName/Roster/AddressBookEntryXmlAction/Parse/Request'
			BEGIN
				
				EXEC [dbo].[companyname_roster_addressbookentryxmlaction_parse_request_message_handler] 
